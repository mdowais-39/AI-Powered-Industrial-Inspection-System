pub mod xfeatures2d {
	...
	opencv_type_enum! { crate::xfeatures2d::BEBLID_BeblidSize { SIZE_512_BITS, SIZE_256_BITS } }
	...
	opencv_type_enum! { crate::xfeatures2d::DAISY_NormalizationType { NRM_NONE, NRM_PARTIAL, NRM_FULL, NRM_SIFT } }
	...
	opencv_type_enum! { crate::xfeatures2d::PCTSignatures_DistanceFunction { L0_25, L0_5, L1, L2, L2SQUARED, L5, L_INFINITY } }
	...
	opencv_type_enum! { crate::xfeatures2d::PCTSignatures_PointDistribution { UNIFORM, REGULAR, NORMAL } }
	...
	opencv_type_enum! { crate::xfeatures2d::PCTSignatures_SimilarityFunction { MINUS, GAUSSIAN, HEURISTIC } }
	...
	opencv_type_enum! { crate::xfeatures2d::TEBLID_TeblidSize { SIZE_256_BITS, SIZE_512_BITS } }
	...
	/// GMS (Grid-based Motion Statistics) feature matching strategy described in [Bian2017gms](https://docs.opencv.org/4.12.0/d0/de3/citelist.html#CITEREF_Bian2017gms) .
	/// ## Parameters
	...
	/// LOGOS (Local geometric support for high-outlier spatial verification) feature matching strategy described in [Lowry2018LOGOSLG](https://docs.opencv.org/4.12.0/d0/de3/citelist.html#CITEREF_Lowry2018LOGOSLG) .
	/// ## Parameters
	/// * keypoints1: Input keypoints of image1.
	/// * keypoints2: Input keypoints of image2.
	...
	impl TEBLID {
		...
		#[inline]
		pub fn default() -> crate::xfeatures2d::TEBLID {
			let ret = unsafe { sys::cv_xfeatures2d_TEBLID_defaultNew_const() };
			let ret = unsafe { crate::xfeatures2d::TEBLID::opencv_from_extern(ret) };
			ret
		}
