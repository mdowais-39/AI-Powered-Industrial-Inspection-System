...
void cv_imdecodeWithMetadata_const__InputArrayR_vectorLintGR_const__OutputArrayR(const cv::_InputArray* buf, std::vector<int>* metadataTypes, const cv::_OutputArray* metadata, Result<cv::Mat*>* ocvrs_return) {
	try {
		cv::Mat ret = cv::imdecodeWithMetadata(*buf, *metadataTypes, *metadata);
		Ok(new cv::Mat(ret), ocvrs_return);
	} OCVRS_CATCH(ocvrs_return);
}

void cv_imdecodeWithMetadata_const__InputArrayR_vectorLintGR_const__OutputArrayR_int(const cv::_InputArray* buf, std::vector<int>* metadataTypes, const cv::_OutputArray* metadata, int flags, Result<cv::Mat*>* ocvrs_return) {
	try {
		cv::Mat ret = cv::imdecodeWithMetadata(*buf, *metadataTypes, *metadata, flags);
		Ok(new cv::Mat(ret), ocvrs_return);
	} OCVRS_CATCH(ocvrs_return);
}
...
void cv_imencodeWithMetadata_const_StringR_const__InputArrayR_const_vectorLintGR_const__InputArrayR_vectorLunsigned_charGR(const char* ext, const cv::_InputArray* img, const std::vector<int>* metadataTypes, const cv::_InputArray* metadata, std::vector<unsigned char>* buf, Result<bool>* ocvrs_return) {
	try {
		bool ret = cv::imencodeWithMetadata(std::string(ext), *img, *metadataTypes, *metadata, *buf);
		Ok(ret, ocvrs_return);
	} OCVRS_CATCH(ocvrs_return);
}

void cv_imencodeWithMetadata_const_StringR_const__InputArrayR_const_vectorLintGR_const__InputArrayR_vectorLunsigned_charGR_const_vectorLintGR(const char* ext, const cv::_InputArray* img, const std::vector<int>* metadataTypes, const cv::_InputArray* metadata, std::vector<unsigned char>* buf, const std::vector<int>* params, Result<bool>* ocvrs_return) {
	try {
		bool ret = cv::imencodeWithMetadata(std::string(ext), *img, *metadataTypes, *metadata, *buf, *params);
		Ok(ret, ocvrs_return);
	} OCVRS_CATCH(ocvrs_return);
}
...
void cv_imreadWithMetadata_const_StringR_vectorLintGR_const__OutputArrayR(const char* filename, std::vector<int>* metadataTypes, const cv::_OutputArray* metadata, Result<cv::Mat*>* ocvrs_return) {
	try {
		cv::Mat ret = cv::imreadWithMetadata(std::string(filename), *metadataTypes, *metadata);
		Ok(new cv::Mat(ret), ocvrs_return);
	} OCVRS_CATCH(ocvrs_return);
}

void cv_imreadWithMetadata_const_StringR_vectorLintGR_const__OutputArrayR_int(const char* filename, std::vector<int>* metadataTypes, const cv::_OutputArray* metadata, int flags, Result<cv::Mat*>* ocvrs_return) {
	try {
		cv::Mat ret = cv::imreadWithMetadata(std::string(filename), *metadataTypes, *metadata, flags);
		Ok(new cv::Mat(ret), ocvrs_return);
	} OCVRS_CATCH(ocvrs_return);
}
...
void cv_imwriteWithMetadata_const_StringR_const__InputArrayR_const_vectorLintGR_const__InputArrayR(const char* filename, const cv::_InputArray* img, const std::vector<int>* metadataTypes, const cv::_InputArray* metadata, Result<bool>* ocvrs_return) {
	try {
		bool ret = cv::imwriteWithMetadata(std::string(filename), *img, *metadataTypes, *metadata);
		Ok(ret, ocvrs_return);
	} OCVRS_CATCH(ocvrs_return);
}

void cv_imwriteWithMetadata_const_StringR_const__InputArrayR_const_vectorLintGR_const__InputArrayR_const_vectorLintGR(const char* filename, const cv::_InputArray* img, const std::vector<int>* metadataTypes, const cv::_InputArray* metadata, const std::vector<int>* params, Result<bool>* ocvrs_return) {
	try {
		bool ret = cv::imwriteWithMetadata(std::string(filename), *img, *metadataTypes, *metadata, *params);
		Ok(ret, ocvrs_return);
	} OCVRS_CATCH(ocvrs_return);
}
