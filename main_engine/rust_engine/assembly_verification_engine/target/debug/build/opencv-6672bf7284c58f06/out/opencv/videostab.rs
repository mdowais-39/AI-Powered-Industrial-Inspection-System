pub mod videostab {
	...
	opencv_type_enum! { crate::videostab::MotionModel { MM_TRANSLATION, MM_TRANSLATION_AND_SCALE, MM_ROTATION, MM_RIGID, MM_SIMILARITY, MM_AFFINE, MM_HOMOGRAPHY, MM_UNKNOWN } }
